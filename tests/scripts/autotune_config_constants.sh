...
[null-tunable-sla-class]='error: error validating "'${yaml_path}/${autotune_config_tests[15]}/null-tunable-sla-class.yaml'": error validating data: '${validation_error}'.sla_class\[0\]; if you choose to ignore these errors, turn validation off with --validate=false' 
